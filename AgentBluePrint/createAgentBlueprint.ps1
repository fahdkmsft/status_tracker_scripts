...
$scopes = "Chat.ReadWrite Files.Read.All Mail.ReadWrite Mail.Send Sites.Read.All User.Read.All OnlineMeetingTranscript.Read.All CallTranscripts.Read.All OnlineMeetings.Read.All"
